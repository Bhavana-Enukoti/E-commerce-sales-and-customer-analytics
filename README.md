...
Imported data into MySQL and performed SQL analysis.
Connected Python to MySQL for advanced analytics.
Performed RFM Analysis, Customer Retention Analysis, and Revenue Forecasting.
